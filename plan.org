...
** DOCUMENT [#A] update networking specification
...
*** TODO Implement new functions in ~scenario.h~ [0/5]
    - [ ] make_player_data
    - [ ] free_player_data
    - [ ] make_player_public_data
    - [ ] player_public_data_get
    - [ ] free_player_public_data
      
*** TODO write unit tests for message functions
    - [ ] scenario_tick
    - [ ] player_update
