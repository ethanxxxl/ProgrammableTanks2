...
*** DOCUMENT Implement new functions in ~scenario.h~ [5/5]
    - [X] make_player_data
    - [X] free_player_data
...
*** DOCUMENT write unit tests for message functions
    - [X] scenario_tick
    - [X] player_update
...
*** TODO revamp message headers.
    ...
    - [ ] Make a message_header structure
    - [ ] Update message code to use the header structure
    - [ ] send header/body in a single write command
